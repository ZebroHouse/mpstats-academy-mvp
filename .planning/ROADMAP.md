...
Plans:
- [ ] 61.1-01-PLAN.md — W1: задачи → Избранное (AgentSearch recommend / JobCard / JobDetail на сердечке)
- [ ] 61.1-02-PLAN.md — W1b: редизайн Плана в плоский вид (задачи + уроки с бейджем приоритета)
- [ ] 61.1-03-PLAN.md — W1b: разовый owner-gated клин-ап addedJobs на проде (скрипт + Mgmt API)
- [ ] 61.1-04-PLAN.md — W2: добивка нейминга джоба→задача / трек→план по живым компонентам
- [ ] 61.1-05-PLAN.md — W3: 2-й уровень навигации (урок из задачи сохраняет контекст в крошках)
