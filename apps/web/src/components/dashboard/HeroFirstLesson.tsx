 ...
 * so it can sit unconditionally in the dashboard layout. Gradient treatment
 * carries the page's primary accent (the greeting island is deliberately calm).
 */
export function HeroFirstLesson() {
  ...
  return (
    <Link
      ...
      style={{ backgroundImage: 'linear-gradient(120deg, #0F172A 0%, #1E3A8A 55%, #2C4FF8 100%)' }}
    >
